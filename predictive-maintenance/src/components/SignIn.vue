<template>
   <main class="form-container">
    <div class="header">
        ...
        <div class="nav">
            <router-link to="/sign-in" class="sign-up">Sign in</router-link>
    ...
    <form @submit.prevent="handleSubmit">
        <div class="container">
            ...
            <p>Create new account <router-link to="/sign-up">sign up?</router-link></p>
        </div>
    </form>
   </main>
  </template>
  ...
  export default {
    ...
    methods: {
        async handleSubmit() {
            try {
                const response = await axios.post('http://localhost:8000/api/signin.php', {
                email: this.email,
                ...
                toast.error('An error occurred while signing user in, please try again later.');
            }
        }
    },
  };
